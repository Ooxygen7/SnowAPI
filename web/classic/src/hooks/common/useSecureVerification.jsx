...
export const useSecureVerification = ({
  ...
  const startVerification = useCallback(
    async (apiCall, options = {}) => {
      ...
      if (!methods.hasPassword && !methods.hasPasskey) {
        const errorMessage = t('请先设置密码或启用 Passkey 才能执行此操作');
  ...
  return {
    ...
    hasAnyVerificationMethod:
      verificationMethods.hasPassword || verificationMethods.hasPasskey,
