...
import { invitationLogin, login, wechatLoginByCode } from '@/features/auth/api'
...
export function UserAuthForm({
  ...
  const invitationRegistrationEnabled =
  ...
  async function onSubmit(data: z.infer<typeof loginFormSchema>) {
    ...
    setIsLoading(true)
    try {
      const loginRequest = passwordLoginEnabled ? login : invitationLogin
