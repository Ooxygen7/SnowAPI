...
>(function ModelRatioVisualEditor(
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='grid h-[clamp(720px,calc(100vh-12rem),900px)] min-h-0 min-w-0 gap-4 xl:grid-cols-[minmax(300px,0.72fr)_minmax(520px,1.28fr)] 2xl:grid-cols-[minmax(320px,0.68fr)_minmax(640px,1.32fr)]'>
