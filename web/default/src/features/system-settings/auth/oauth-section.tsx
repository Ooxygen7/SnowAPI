...
const oauthSchema = z.object({
  ...
  LinuxDOOAuthInvitationRequired: z.boolean(),
...
type FlatOAuthDefaults = {
  ...
  LinuxDOOAuthInvitationRequired: boolean
...
const buildFormDefaults = (defaults: FlatOAuthDefaults): OAuthFormValues => ({
  ...
  LinuxDOOAuthInvitationRequired: defaults.LinuxDOOAuthInvitationRequired,
...
const normalizeFormValues = (values: OAuthFormValues): FlatOAuthDefaults => ({
  ...
  LinuxDOOAuthInvitationRequired: values.LinuxDOOAuthInvitationRequired,
          ...
          <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value='linuxdo' className={oauthTabContentClassName}>
                ...
                <FormField
                  control={form.control}
                  name='LinuxDOOAuthInvitationRequired'
                  render={({ field }) => (
                    <SettingsSwitchItem>
                      <SettingsSwitchContent>
                        <FormLabel>
                          {t(
                            'Require an invitation code for new LinuxDO users'
                          )}
                        </FormLabel>
                        <FormDescription>
                          {t(
                            'Existing LinuxDO users can still sign in without a code. New accounts must use a valid one-time invitation code.'
                          )}
                        </FormDescription>
                      </SettingsSwitchContent>
                      <FormControl>
