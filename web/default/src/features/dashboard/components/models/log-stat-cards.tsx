      ...
      <div className='divide-border/60 grid min-w-0 grid-cols-2 divide-x sm:grid-cols-3 lg:grid-cols-5'>
        {items.map((it, idx) => {
          ...
          if (loading) {
            ...
            valueContent = (
              <>
                <div className='text-muted-foreground mt-1 text-base leading-tight font-medium tracking-tight tabular-nums sm:mt-2 sm:text-xl sm:leading-normal'>
                  --
                </div>
            ...
            valueContent = (
              <>
                <div
                  className='text-foreground mt-1 max-w-full truncate text-base leading-tight font-medium tracking-tight tabular-nums sm:mt-2 sm:text-xl sm:leading-normal'
                  title={it.fullValue}
                >
                  {it.value}
                </div>
