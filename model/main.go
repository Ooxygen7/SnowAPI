...
func migrateDB() error {
	...
	if err := migrateMinimalModeSharedModelIndex(); err != nil {
		return err
	}
	...
	err := DB.AutoMigrate(
		...
		&PerfMetric{},
		&ModelHealthHourly{},
		&ModelRequestHealthHourly{},
		&ModelChannelHealthHourly{},
		&IPAuditMinute{},
		&UserRelayBan{},
		&UserRelayBanEvent{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&ModelHealthHourly{}, "ModelHealthHourly"},
		{&ModelRequestHealthHourly{}, "ModelRequestHealthHourly"},
		{&ModelChannelHealthHourly{}, "ModelChannelHealthHourly"},
		{&IPAuditMinute{}, "IPAuditMinute"},
		{&UserRelayBan{}, "UserRelayBan"},
		{&UserRelayBanEvent{}, "UserRelayBanEvent"},
		{&SubscriptionQuotaWindow{}, "SubscriptionQuotaWindow"},
		{&GroupRateLease{}, "GroupRateLease"},
		{&UserAnnouncementRead{}, "UserAnnouncementRead"},
		{&MinimalModeSource{}, "MinimalModeSource"},
		{&MinimalModeModel{}, "MinimalModeModel"},
...
` + "`five_hour_quota`" + ` bigint NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "five_hour_quota", DDL: "`five_hour_quota` bigint NOT NULL DEFAULT 0"},
