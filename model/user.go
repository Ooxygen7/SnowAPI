...
type User struct {
	...
	Group            string                     `json:"group" gorm:"type:varchar(64);default:'Free'"`
	GroupRestore     string                     `json:"-" gorm:"type:varchar(64);column:group_restore"`
	GroupExpiresAt   int64                      `json:"group_expires_at,omitempty" gorm:"column:group_expires_at"`
	AffCode          string                     `json:"-" gorm:"type:varchar(32);column:aff_code;uniqueIndex"`
	AffCount         int                        `json:"-" gorm:"type:int;default:0;column:aff_count"`
	...
	InviterId        int                        `json:"-" gorm:"type:int;column:inviter_id;index"`
	DeletedAt        gorm.DeletedAt             `gorm:"index"`
	LinuxDOId        string                     `json:"linux_do_id" gorm:"column:linux_do_id;index"`
	Setting          string                     `json:"setting" gorm:"type:text;column:setting"`
	Remark           string                     `json:"remark,omitempty" gorm:"type:varchar(255)" validate:"max=255"`
	StripeCustomer   string                     `json:"-" gorm:"type:varchar(64);column:stripe_customer;index"`
...
func (user *User) ToBaseUser() *UserBase {
	cache := &UserBase{
		Id:             user.Id,
		Group:          user.Group,
		GroupRestore:   user.GroupRestore,
...
func GetUserById(id int, selectAll bool) (*User, error) {
	...
	if err == nil {
		err = ResolveExpiredUserGroup(&user)
	}
	return &user, err
}
