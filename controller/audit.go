...
var auditContentTemplates = map[string]string{
	...
	"relay_ban.apply":              "Applied a relay ban to user ${target_user_id}",
	"relay_ban.extend":             "Extended the relay ban for user ${target_user_id}",
	"relay_ban.revoke":             "Revoked the relay ban for user ${target_user_id}",
}
