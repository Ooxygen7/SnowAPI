...
func Relay(c *gin.Context, relayFormat types.RelayFormat) {
	...
	if !service.ShouldPreConsumeBilling(relayInfo) {
...
func shouldRecordModelHealth(relayFormat types.RelayFormat, requestPath string) bool {
	switch relayFormat {
	case types.RelayFormatClaude,
		...
		return true
	case types.RelayFormatGemini:
		return strings.Contains(strings.ToLower(requestPath), "generatecontent")
	case types.RelayFormatOpenAI:
		path := strings.ToLower(strings.TrimSuffix(requestPath, "/"))
...
func RelayTask(c *gin.Context) {
	...
	if taskErr == nil {
		...
		if relayInfo.SubscriptionUsageRef.Valid() {
			usageRef := relayInfo.SubscriptionUsageRef
